...
const walls = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    // displacementMap: bricksNormalTexture,
...
const roof = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({ color: "firebrick" })
);
...
const door = new THREE.Mesh(
  new THREE.PlaneGeometry(2, 2.2, 32, 32),
  new THREE.MeshStandardMaterial({
    color: "brown",
...
const graveMaterial = new THREE.MeshStandardMaterial({ color: "slategray" });
...
for (let i = 0; i < 50; i++) {
  ...
  grave.rotation.y = (Math.random() - 0.5) * (Math.PI / 5);
