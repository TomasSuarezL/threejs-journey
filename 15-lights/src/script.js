...
const hemisphereLight = new THREE.HemisphereLight(0xff00000, 0x0000ff, 0.5);
// scene.add(hemisphereLight);

const pointLight = new THREE.PointLight(0xff9000, 0.5, 6, 2);
pointLight.position.set(1, -0.5, 1);
// scene.add(pointLight);

const rectAreaLight = new THREE.RectAreaLight(0xaaddff, 5, 2, 2);
rectAreaLight.position.set(-1.5, 0, 1.5);
rectAreaLight.lookAt(new THREE.Vector3());

scene.add(rectAreaLight);

const spotLight = new THREE.SpotLight(0x78ff22, 0.5, 10, Math.PI * 0.2, 0.5, 1);
